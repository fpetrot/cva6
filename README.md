...
In the future the 128 toolchain compilation will be directly integrated in the 128 bits project.
...
Before proceeding, source the environment setup script:
