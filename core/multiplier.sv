...
#(
  ...
  always_comb begin : p_selmux
    unique case (operator_q)
      ...
      default: begin
        if (operator_q == MULW && (CVA6Cfg.IS_XLEN128 || CVA6Cfg.IS_XLEN64)) result_o = {{CVA6Cfg.XLEN-32{mult_result_q[31]}}, mult_result_q[31:0]};
        else if (operator_q == MULD && CVA6Cfg.IS_XLEN128) result_o = sext64to128(mult_result_q[63:0]);
