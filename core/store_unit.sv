...
#(
  ...
  // FIXME : certaines valeurs renvoyées sont incorrectes
  // align data to address e.g.: shift data to be naturally 128
  function automatic [CVA6Cfg.XLEN-1:0] data_align(logic [3:0] addr, logic [127:0] data);
    // Set addr[3] and addr[2] to 1'b0 when 32 bits, and addr[3] to 1'b0 when 64 bits
    logic [ 3:0] addr_tmp = {(addr[3] && CVA6Cfg.IS_XLEN128), (addr[2] && ~CVA6Cfg.IS_XLEN32), addr[1:0]};
    logic [127:0] data_tmp = {128{1'b0}};
    case (addr_tmp)
      4'b0000: data_tmp[CVA6Cfg.XLEN-1:0] = {data[CVA6Cfg.XLEN-1:0]};
      4'b0001: data_tmp[CVA6Cfg.XLEN-1:0] = {data[CVA6Cfg.XLEN-9:0], data[CVA6Cfg.XLEN-1:CVA6Cfg.XLEN-8]};
      4'b0010: data_tmp[CVA6Cfg.XLEN-1:0] = {data[CVA6Cfg.XLEN-17:0], data[CVA6Cfg.XLEN-1:CVA6Cfg.XLEN-16]};
      4'b0011: data_tmp[CVA6Cfg.XLEN-1:0] = {data[CVA6Cfg.XLEN-25:0], data[CVA6Cfg.XLEN-1:CVA6Cfg.XLEN-24]};
      4'b0100: data_tmp[CVA6Cfg.XLEN-1:0] = {data[CVA6Cfg.XLEN-33:0], data[CVA6Cfg.XLEN-1:CVA6Cfg.XLEN-32]};
      ...
      4'b1100: data_tmp[CVA6Cfg.XLEN-1:0] = {data[CVA6Cfg.XLEN-97:0], data[CVA6Cfg.XLEN-1:CVA6Cfg.XLEN-96]};
      4'b1101: data_tmp[CVA6Cfg.XLEN-1:0] = {data[CVA6Cfg.XLEN-105:0], data[CVA6Cfg.XLEN-1:CVA6Cfg.XLEN-104]};
      4'b1110: data_tmp[CVA6Cfg.XLEN-1:0] = {data[CVA6Cfg.XLEN-113:0], data[CVA6Cfg.XLEN-1:CVA6Cfg.XLEN-112]};
      4'b1111: data_tmp[CVA6Cfg.XLEN-1:0] = {data[CVA6Cfg.XLEN-121:0], data[CVA6Cfg.XLEN-1:CVA6Cfg.XLEN-120]};
    endcase
  ...
  always_comb begin
    ...
    st_data_n = (CVA6Cfg.RVA && instr_is_amo) ? lsu_ctrl_i.data[CVA6Cfg.XLEN-1:0] :
        data_align(lsu_ctrl_i.vaddr[3:0], {{128 - CVA6Cfg.XLEN{1'b0}}, lsu_ctrl_i.data});
